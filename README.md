...
| :--- | :--- | :--- |
| ⚡ **File Chạy Trực Tiếp (Portable)** | Tải về click đúp chạy ngay, không cần cài đặt. | [⬇️ Tải tauri-file-server.exe](https://github.com/TNQuangHuy207/get-and-pust-form-clien-to-server/releases/download/v1.0.0/tauri-file-server.exe) |
| 📦 **File Cài Đặt (Installer)** | Tự động tạo Shortcut ngoài Desktop & Start Menu. | [⬇️ Tải tauri-file-server-setup.exe](https://github.com/TNQuangHuy207/get-and-pust-form-clien-to-server/releases/download/v1.0.0/tauri-file-server_0.1.0_x64-setup.exe) |
